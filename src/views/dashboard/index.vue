  ...
  <div class="app-container">
    ...
    <el-row class="panel-group" :gutter="40">
      <el-col v-for="(item,index) in data.customerNum" :key="index" :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="pushToCustomer(item.type)">
    ...
    <el-row class="panel-group" :gutter="40">
      <el-col v-for="(item,index) in data.orderNum" :key="index" :xs="12" :sm="12" :lg="6" class="card-panel-col">
        <div class="card-panel" @click="pushToOrder(item.type)">
      ...
      <el-col v-if="data.payedOrder>=0" :xs="12" :sm="12" :lg="6" class="card-panel-col">
...
export default {
  ...
  methods: {
    pushToInfo(){
      this.$router.push("/permission/grouping");
    },
    pushToCustomer(type) {
      console.log(type);
      this.$store.dispatch('NavCustomerList',{ type });
